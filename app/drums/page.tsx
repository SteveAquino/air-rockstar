...
import { useDrumKit, type DrumKitVariant, type DrumPad } from '@/src/hooks/useDrumKit';
...
interface DrumsHeaderProps {
  handsDetected: number;
  isReady: boolean;
}

const DrumsHeader = ({ handsDetected, isReady }: DrumsHeaderProps) => (
...
interface DrumsSetupCardProps {
  isRequesting: boolean;
  onEnable: () => void;
}

const DrumsSetupCard = ({ isRequesting, onEnable }: DrumsSetupCardProps) => (
...
interface DrumsVideoStageProps {
...
interface DrumsStatsProps {
  combo: number;
  tempoLabel: string;
  hits: number;
}

const DrumsStats = ({ combo, tempoLabel, hits }: DrumsStatsProps) => (
