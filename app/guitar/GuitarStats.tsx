...
import type { GuitarStatsProps } from './types';
import { GUITAR_HELP_TEXT } from './constants';
import styles from './page.module.css';

export function GuitarStats({ combo, tempoLabel, hits }: GuitarStatsProps) {
  return (
    <div className={styles.statsRow}>
      <div className={styles.stat}>
        <div className={styles.statHeader}>
          <span className={styles.statLabel}>Combo</span>
          <HelpTooltip label="Help: Combo" text={GUITAR_HELP_TEXT.combo} />
        </div>
      ...
      <div className={styles.stat}>
        <div className={styles.statHeader}>
          ...
          <HelpTooltip label="Help: Tempo" text={GUITAR_HELP_TEXT.tempo} />
        </div>
      ...
      <div className={styles.stat}>
        <div className={styles.statHeader}>
          ...
          <HelpTooltip label="Help: Hits" text={GUITAR_HELP_TEXT.hits} />
        </div>
